  ...
  return (
    <div className='w-full px-4 bg-amazon_light h-[36px] text-white flex items-center'>
        <ul className='flex items-center gap-2 text-sm tracking-wide'>
            ...
            <li className='headerHover hidden md:inline-flex'>Registy</li>
        ...
        {sidebar && (
            <div  className='w-full h-screen bg-amazon_blue fixed top-0 left-0 bg-opacity-50 '>
                <div className='w-full h-full relative'>
                    ...
                    <span onClick={()=>setSideBar(prev=> !prev)} className='absolute top-0 left-[82%] md:left-[360px] cursor-pointer w-10 h-10 text-black bg-gray-200 flex items-center justify-center hover:bg-red-500 hover:text-white border duration-300'><CloseIcon /></span>
                    </motion.div>
                </div>
            </div>
        )}
